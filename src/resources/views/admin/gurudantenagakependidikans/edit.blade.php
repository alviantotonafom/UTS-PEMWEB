...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.gurudantenagakependidikan.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.gurudantenagakependidikans.update", [$gurudantenagakependidikan->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                <label for="fullname">{{ trans('cruds.gurudantenagakependidikan.fields.fullname') }}</label>
            ...
            <div class="form-group">
                <label for="dateofbirth">{{ trans('cruds.gurudantenagakependidikan.fields.dateofbirth') }}</label>
            ...
            <div class="form-group">
              <label class="required" for="gender">{{ trans('cruds.gurudantenagakependidikan.fields.gender') }}</label>
            ...
            <div class="form-group">
                <label class="required" for="phone">{{ trans('cruds.gurudantenagakependidikan.fields.phone') }}</label>
            ...
            <div class="form-group">
                <label class="required" for="email">{{ trans('cruds.gurudantenagakependidikan.fields.email') }}</label>
            ...
            <div class="form-group">
                <label for="hiredate">{{ trans('cruds.gurudantenagakependidikan.fields.hiredate') }}</label>
